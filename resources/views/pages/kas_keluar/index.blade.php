                    ...
                    <div class="card-header d-flex  justify-content-between">
                        ...
                        <div class="table-tools d-flex justify-content-around ">
                            ...
                            <button type="button" class="btn bg-main text-white float-right">
                                <a href="{{ URL::to('/admin/kas_keluar/create') }}" type="button"
                            ...
                            <tbody>
                                @foreach ($kas_keluar as $row)
                                    <tr>
                                        ...
                                        <td>Rp. {{ number_format($row->kas_keluar) }}</td>
                                        <td>
                                            <a href="{{ URL::to('/admin/kas_keluar/edit/' . $row->id) }}"
                                                class="btn btn-primary">Edit</a>
                                            <form action="{{ URL::to('/admin/kas_keluar/delete/' . $row->id) }}"
